...
## 📦 CAIXA 5: EXTERNAL DATABASE (OPCIONAL)

**⚠️ SÓ COLE ESTA SE SEU PROJETO CONECTA EM DATABASE/API EXTERNO QUE VOCÊ NÃO CONHECE**

```
Create the file .cursor/rules/10-external-database.mdc with this EXACT content:
